...
### .Net
* https://github.com/mkader/Model-Context-Protocol/blob/main/04_1.program.cs
    ```
    # Create project
...
### Python
* https://github.com/mkader/Model-Context-Protocol/blob/main/04_2.server.py
```
# Create project
...
# However, it doesn't implement all the methods available on the tool
mcp dev server.py

# so you're recommended to run the Node.js tool directly like below:
