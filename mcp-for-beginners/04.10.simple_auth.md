...
* Server - Create a web server and MCP instance. Implement a middleware for the server.
* Client - Send web request, with credential, via header.

1. Create a web server and MCP instance - create a starlette web app and host it with uvicorn.
