...
* MCP server handles large datasets - whether listing thousands of files, db records or search results - you need pagination to manage memory efficiently and provide responsive user experiences.
