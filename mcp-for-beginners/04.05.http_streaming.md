...
```
<img width="450" height="100" alt="image" src="https://github.com/user-attachments/assets/a2a85a0c-a0a7-46f5-a1ce-8c7452ffd4d9" />
<img width="511" height="955" alt="image" src="https://github.com/user-attachments/assets/ce7ff594-86cb-41f6-90cd-527b672debfb" />
<img width="440" height="187" alt="image" src="https://github.com/user-attachments/assets/ac91404d-843e-4d98-b716-51d89513aa0a" />
...
with requests.get("http://localhost:8000/stream", stream=True) as r:
    for line in r.iter_lines():
        if line:
            print(line.decode())
```
<img width="50" height="150" alt="image" src="https://github.com/user-attachments/assets/1cc544f9-3f51-41de-9bd4-426aab08b4c0" />
