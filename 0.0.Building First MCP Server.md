...
* Testing Your Server - Need an MCP client, use the MCP Inspector tool or integrate it with Claude Desktop.
  1. Refer <a href="https://github.com/mkader/Model-Context-Protocol/blob/main/0.1.Building%20Weather%20MCP%20Server.md">Building Weather MCP Server: A Beginners Tutorial</a> to run, the below code won't work
