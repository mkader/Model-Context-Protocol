...
### Step 6: Integration with VS Code and GitHub Copilot
  1. Refer <a href="https://docs.github.com/en/copilot/how-tos/provide-context/use-mcp-in-your-ide/use-the-github-mcp-server">Using the GitHub MCP Server in your IDE</a>
      	...
      	"servers": {
      		"my-mcp-server-8c35603c": {
      			...
      			"args": [
      				"-y",
      				"tsx",
      				"main.ts" or "weather-server/main.ts"
      			]
      		}
      	},
      	"inputs": []
