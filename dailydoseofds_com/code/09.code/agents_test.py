...
def LinkUpSearchTool():
    output_type: str = "searchResults"
    depth: str = "standard"
    query: str = "do a deep researvh on how SLMs(Small Language models) are reshaping the enterprise"
    ...
    try:
        ...
        # Perform a web search for your AI workflow
