...
query = "short summary of unsucceful attempt from deepstack.pdf"

groundx_client = GroundX(
  api_key=os.getenv("GROUNDX_AI_API_KEY")
)
...
<img width="858" height="372" alt="image" src="https://github.com/user-attachments/assets/4c72c56c-eec1-46a0-9395-7056673e2083" />
